...
let editor = renderer["a" /* default */].create('<div class="note-editor note-frame panel panel-default"/>');
let toolbar = renderer["a" /* default */].create('<div class="panel-heading note-toolbar" role="toolbar"/>');
...
let dropdown = renderer["a" /* default */].create('<ul class="note-dropdown-menu dropdown-menu">', function ($node, options) {
...
let dropdownCheck = renderer["a" /* default */].create('<ul class="note-dropdown-menu dropdown-menu note-check">', function ($node, options) {
  let markup = Array.isArray(options.items) ? options.items.map(function (item) {
    let value = typeof item === 'string' ? item : item.value || '';
    let content = options.template ? options.template(item) : item;
