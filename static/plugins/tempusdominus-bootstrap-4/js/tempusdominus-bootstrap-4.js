...
let version = moment.version.split('.')
...
let DateTimePicker = function ($, moment) {
  ...
  let Default = {
    ...
    keyBinds: {
      up: function up() {
        ...
        let d = this._dates[0] || this.getMoment();
  ...
  let DateTimePicker = /*#__PURE__*/function () {
    ...
    let _proto = DateTimePicker.prototype;

    //private
    _proto._int = function _int() {
      this.isInit = true;

      let targetInput = this._element.data('target-input');
    ...
    _proto._indexGivenDates = function _indexGivenDates(givenDatesArray) {
      ...
      $.each(givenDatesArray, function () {
        let dDate = self._parseInputDate(this);
    ...
    _proto.maxDate = function maxDate(_maxDate) {
      ...
      let parsedDate = this._parseInputDate(_maxDate);
    ...
    _proto.minDate = function minDate(_minDate) {
      ...
      let parsedDate = this._parseInputDate(_minDate);
    ...
    _proto.defaultDate = function defaultDate(_defaultDate) {
      ...
      let parsedDate = this._parseInputDate(_defaultDate);
...
let TempusDominusBootstrap4 = function ($) {
  // eslint-disable-line no-unused-lets
  // ReSharper disable once InconsistentNaming
  let JQUERY_NO_CONFLICT = $.fn[DateTimePicker.NAME],
  ...
  let TempusDominusBootstrap4 = /*#__PURE__*/function (_DateTimePicker) {
    ...
    let _proto2 = TempusDominusBootstrap4.prototype;

    _proto2._init = function _init() {
      if (this._element.hasClass('input-group')) {
        let datepickerButton = this._element.find('.datepickerbutton');
    ...
    _proto2._getTimePickerTemplate = function _getTimePickerTemplate() {
      let hoursView = $('<div>').addClass('timepicker-hours').append($('<table>').addClass('table-condensed')),
    ...
    _proto2._getTemplate = function _getTemplate() {
      let template = $('<div>').addClass(("bootstrap-datetimepicker-widget dropdown-menu " + (this._options.calendarWeeks ? 'tempusdominus-bootstrap-datetimepicker-widget-with-calendar-weeks' : '') + " " + ((this._useFeatherIcons() ? 'tempusdominus-bootstrap-datetimepicker-widget-with-feather-icons' : '') + " ")).trim()),
    ...
    _proto2._place = function _place(e) {
      let self = e && e.data && e.data.picker || this,
          ...
          parent;
      let position = (self.component && self.component.length ? self.component : self._element).position(),
    ...
    _proto2._updateMonths = function _updateMonths() {
      let monthsView = this.widget.find('.datepicker-months'),
    ...
    _proto2._updateYears = function _updateYears() {
      let yearsView = this.widget.find('.datepicker-years'),
    ...
    _proto2._updateDecades = function _updateDecades() {
      let decadesView = this.widget.find('.datepicker-decades'),
    ...
    _proto2._fillDate = function _fillDate() {
      ...
      let daysView = this.widget.find('.datepicker-days'),
      ...
      for (i = 0; i < 42; i++) {
        ...
        if (this._options.allowMultidate) {
          let index = this._datesFormatted.indexOf(currentDate.format('YYYY-MM-DD'));
    ...
    _proto2._fillHours = function _fillHours() {
      let table = this.widget.find('.timepicker-hours table'),
    ...
    _proto2._fillMinutes = function _fillMinutes() {
      let table = this.widget.find('.timepicker-minutes table'),
    ...
    _proto2._fillSeconds = function _fillSeconds() {
      let table = this.widget.find('.timepicker-seconds table'),
    ...
    _proto2._fillTime = function _fillTime() {
      ...
      let timeComponents = this.widget.find('.timepicker span[data-time-component]'),
          lastPickedDate = this._getLastPickedDate();
    ...
    _proto2._doAction = function _doAction(e, action) {
      ...
      switch (action) {
        case 'next':
          {
            let navFnc = DateTimePicker.DatePickerModes[this.currentViewMode].NAV_FUNCTION;
        ...
        case 'previous':
          {
            let _navFnc = DateTimePicker.DatePickerModes[this.currentViewMode].NAV_FUNCTION;
        ...
        case 'selectDecade':
          {
            let _year = parseInt($(e.target).data('selection'), 10) || 0;
        ...
        case 'selectDay':
          {
            ...
            let selectDate = day.date(parseInt($(e.target).text(), 10)),
                index = 0;
        ...
        case 'incrementHours':
          {
            ...
            let newDate = lastPicked.clone().add(1, 'h');
        ...
        case 'incrementMinutes':
          {
            ...
            let _newDate = lastPicked.clone().add(this._options.stepping, 'm');
        ...
        case 'incrementSeconds':
          {
            ...
            let _newDate2 = lastPicked.clone().add(1, 's');
        ...
        case 'decrementHours':
          {
            ...
            let _newDate3 = lastPicked.clone().subtract(1, 'h');
        ...
        case 'decrementMinutes':
          {
            ...
            let _newDate4 = lastPicked.clone().subtract(this._options.stepping, 'm');
        ...
        case 'decrementSeconds':
          {
            ...
            let _newDate5 = lastPicked.clone().subtract(1, 's');
    ...
    _proto2.hide = function hide() {
      ...
      let lastPickedDate = this._getLastPickedDate();
    ...
    _proto2.setMultiDate = function setMultiDate(multiDateArray) {
      let dateFormat = this._options.format;
      this.clear();
